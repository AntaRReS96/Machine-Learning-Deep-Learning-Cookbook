from snake_config import BLOCK_SIZE, WIN_NN_WIDTH, WIN_NN_HEIGHT, DISPLAY_SPLIT, GAME_SPEED
from snake_display_nn import GameDisplay  
import pygame
from enum import Enum
import random
import numpy as np

WIN_WIDTH = DISPLAY_SPLIT
...
class Snake:
    ...
    def is_collided(self, block=None):
        ...
        for body_block in self.snake_elements[1:]:
            if block[0] == body_block[0] and block[1] == body_block[1]:
                return True
        return False
...
class Apple:
    ...
    def spawn_apple(self):
        ...
        all_positions = [
            ...
            for y in range(0, WIN_NN_HEIGHT, BLOCK_SIZE)
        ]
...
class SnakeGameAI:
    def __init__(self, nn_model):
        self.width = WIN_NN_WIDTH
        self.height = WIN_NN_HEIGHT
    ...
    def reset(self):
        ...
        self.snake = Snake(WIN_NN_WIDTH / 4, self.height / 2)
        self.apple = Apple(self)
        self.game_over = False
        self.score = 0
        return self._get_state()

    def play_step(self, action, activations):
        ...
        self.display.update_display(self.snake, self.apple, self.model, activations, self.score)  
    ...
    def _get_state(self):
        ...
        max_distance = WIN_WIDTH + self.height  # Dostosowane do rozmiaru okna
