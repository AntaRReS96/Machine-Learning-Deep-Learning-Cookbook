...
1. **🏠 California Housing Prices**: Regression analysis on real estate data.
2. **🖼️ Image Classification**: CNN-based model using Keras.
3. **🖊️ Sentiment Analysis**: Text classification and generation with NLP.
...
- **🛠️ Tools**: Numpy, Pandas, Matplotlib
...
* [Główne Koncepcje](#główne-koncepcje)
    * [Uczenie Nadzorowane](#uczenie-nadzorowane)
    * [Uczenie Nienadzorowane](#uczenie-nienadzorowane)
    * [Uczenie Głębokie](#uczenie-głębokie)
* [Ekosystem Python](#ekosystem-python)
    * [Scikit-Learn](#scikit-learn)
    * [Keras](#keras)
    * [TensorFlow](#tensorflow)
* [Projekty](#projekty)
...
- Drzewa Decyzyjne i Modele Zespołowe

### Uczenie Nienadzorowane
- Grupowanie (K-means, DBSCAN)
- Redukcja wymiarowości (PCA, t-SNE)
- Wykrywanie anomalii

### Uczenie Głębokie
- Sieci Neuronowe (Feedforward, CNN, RNN)
- Mechanizmy Uwagowe i Transformatory
- GAN-y i Autoenkodery
...
1. **🏠 Ceny Nieruchomości w Kalifornii**: Analiza regresji danych.
2. **🖼️ Klasyfikacja Obrazów**: Model CNN z Keras.
3. **🖊️ Analiza Opinii**: Klasyfikacja tekstu z NLP.
...
- **🛠️ Narzędzia**: Numpy, Pandas, Matplotlib
